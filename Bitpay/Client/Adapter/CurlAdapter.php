...
class CurlAdapter implements AdapterInterface
{
    ...
    private function getCurlDefaultOptions(RequestInterface $request)
    {
        ...
        if (gethostname() == 'CGF6135T'){
            ...
            $array = array(
                CURLOPT_URL            => $request->getUri(), //sono diversi da btcpay server
                CURLOPT_PORT           => $request->getPort(), //sono diversi da btcpay server
                ...
                //MODIFICHE BY SERGIO CASIZZONE X bypassare PROXY AGENZIA ENTRATE
